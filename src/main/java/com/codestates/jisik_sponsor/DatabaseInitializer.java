...
import com.codestates.jisik_sponsor.project.repository.ProjectRepository;
...
public class DatabaseInitializer {
    ...
    @Bean
    public CommandLineRunner initDatabase(MemberRepository memberRepository, ProjectRepository projectRepository) {
        return args -> {
